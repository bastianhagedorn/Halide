...
def plot(app):
    pl = ggplot("subset(data, (data$app == '{0}') & (data$threads == 500 | data$threads == 1000 | data$threads == 2000 | data$threads == 4000 | data$threads == 8000))".format(app),
...
for app in apps:
    ...
    # select
    reldata = res[((res.threads == 500) | (res.threads == 1000) | (res.threads == 2000) | (res.threads == 4000) | (res.threads == 8000)) & (res.app == app)]
